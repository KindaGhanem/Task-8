...
export default function Hero (){
    ...
    <div className='hero' id='Home'>
        ...
        <div className='hero-img'>
            <img src='./src/assets/img/gamefor-mobile.png' alt='img-hero1' className='img-hero1'></img>
            <img src='./src/assets/img/brandingpattren.png' alt='img-hero2' className='img-hero2'></img>
        </div>
        <div>
